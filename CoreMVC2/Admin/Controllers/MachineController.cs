...
namespace CoreMVC2.Admin.Controllers
{
    public class MachineController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Name,Id,IsActive,CreatedUserId,CreatedDate,UpdatedUserId,UpdatedDate")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Id,IsActive,CreatedUserId,CreatedDate,UpdatedUserId,UpdatedDate")] Machine machine)
        {
            if (id != machine.Id)
            {
                return NotFound();
